...
[source,bash,role=execute]
----
oc apply -f pipelines/openshift/pv-claim.yaml
----
\\\\
...
[source,bash,role=execute]
----
vi pipelines/openshift/03-pipeline-run.yaml
----
...
[source,bash,role=execute]
----
oc apply -f pipelines/openshift/03-pipeline-run.yaml
----
\\\\
```
apiVersion: tekton.dev/v1beta1
