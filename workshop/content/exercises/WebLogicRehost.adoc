...
[source,bash,role=execute]
----
oc new-project weblogic-operator-%username%
----
...
[source,bash,role=execute]
----
oc create serviceaccount -n weblogic-operator-%username% weblogic-operator-sa
----
...
helm install weblogic-operator weblogic-kubernetes-operator/kubernetes/charts/weblogic-operator \
  --namespace weblogic-operator-%username% \
...
### Part 5: View the Administration Portal and Application
