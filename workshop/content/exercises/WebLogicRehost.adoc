...
First, we need to assign you a unique port number. Run the following series of commands:
[source,bash,role=execute]
----
USER_NUM=$(echo %username% | tr -dc '0-9')
----
[source,bash,role=execute]
----
USER_PORT=$(($USER_NUM + 30701))
----
The following command will display your port number. You do not need to do anything with this value.
[source,bash,role=execute]
----
echo USER_PORT
----
